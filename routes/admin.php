...
define('PAGINATION_COUNT',10);//3add eli hyselect mn db
    Route::group(['namespace' => 'Admin', 'middleware' => 'auth:admin'], function () {
    Route::get('/', 'DashboardController@index')->name('admin.dashboard');

    ######################### Begin Languages Route ########################
    Route::group(['prefix' => 'languages'], function () {
        Route::get('/','LanguagesController@index') -> name('admin.languages'); //gay mn anchor fe side bar
...
Route::group(['namespace' => 'Admin'/*ay controller mwgof fe l admin Admin/con*/ , 'middleware' => 'guest:admin'/*for any one*/], function () {
    Route::get('login', 'LoginController@getLogin')->name('get.admin.login'); //route was getting from action 
    Route::post('login', 'LoginController@login')->name('admin.login');//from auth.login method post
});
########################### end of main routes ####################
